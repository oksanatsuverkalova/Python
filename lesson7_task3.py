...
class Cell:
    ...
    def __add__(self, other):
        return f'Число ячеек общей клетки суммарно равно : {self.quantity + other.quantity} клеткам'

    def __sub__(self, other):
        sub = self.quantity - other.quantity
        return f'Число ячеек общей клетки уменьшилось и равно: {sub} клеткам' if sub > 0 else 'Вычитание невозможно'
